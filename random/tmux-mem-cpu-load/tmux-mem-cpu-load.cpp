...
// OSX or BSD based system, use BSD APIs instead
  ...
  float percentage = static_cast<float>(used_mem)/static_cast<float>(total_mem) * 100;
...
int main(int argc, char** argv)
{
  ...
  std::cout << "#[fg=colour110]mem: " << mem_string( use_colors ) << "#[fg=colour176] cpu:" << cpu_string( cpu_usage_delay, graph_lines, use_colors );
